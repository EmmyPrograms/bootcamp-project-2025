    ...
    <div className="flex justify-start max-w-5xl mx-auto mt-12 ">
      ...
      <div className=" absolute top-1/3 right-40 panel">
        ...
        <p className="text-base leading-relaxed">
          ...
          Cal Poly Quantitative Finance Club, tutoring my peers in a variety of
          STEM coursework, thrifting with the Cal poly Sustainability Club, and
          connecting with others like me who are enthusiastic about technology,
          innovative solutions, and science.
        </p>
      </div>
